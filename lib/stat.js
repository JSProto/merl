...
let page = {
    ...
    cachegamer: path + 'Earnings_download.php',
    ...
    return new Promise(function(resolve, reject){
        ...
        request.get(page.login).then(function(res){
            ...
            request.post(page.profile, {txtusername, txtpassword}).then(res => {
                ...
                request.get(page.cachegamer).then(res => {
                    let json2 = router.grab(page.cachegamer, res.body);

                    resolve(Object.assign(json, json2));
                }).catch(reject);
